...
#                     'path/to/model.ckpt')
flags.DEFINE_string('output_directory', None, 'Path to write outputs - the export module.')
...
def trainer():
    ...
    config = tf.estimator.RunConfig(model_dir=FLAGS.model_dir, keep_checkpoint_max=500)  # XXX: Manually adding `keep_checkpoint_max`
