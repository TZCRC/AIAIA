...
# @tf.function #adding this I got requests.exceptions.HTTPError: 499 Client Error
def _encoded_image_string_tensor_input_placeholder(input_shape=None):
  ...
  with tf.device("/cpu:0"):
      return (batch_image_str_placeholder, tf.map_fn(decode,
      elems=batch_image_str_placeholder,dtype=tf.uint8,parallel_iterations=32,back_prop=False))
